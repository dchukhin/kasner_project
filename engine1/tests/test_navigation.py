...
def w_driver(request):
    ...
    request.addfinaliser(driver.quit)
    return driver
...
def test_navigates_to_index_page_then_about_page(w_driver)
    ...
    assert(test_found1 != None and test_found2 != None)
...
def test_navigates_to_index_page_then_about_page_then_index_page(w_driver)
    ...
    assert(text_found1 != None and text_found2 != None and text_found3 != None)
